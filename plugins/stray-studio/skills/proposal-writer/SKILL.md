...
description: "Use when the user needs a persuasive decision document such as a proposal, plan, internal request, business case, or approval-seeking memo where the goal is to secure alignment, funding, permission, or a go-ahead. Do not use for publishable articles, editorial writing, or general brainstorming without a decision target."
---
...
5. Tighten the approval path.
   ...
   - Make the next step obvious, including who acts, what happens next, and by when if relevant.
