...
- Run `PYTHONDONTWRITEBYTECODE=1 uv run --with pytest==9.1.1 --with pillow==12.3.0 --with numpy==2.4.3 python -m pytest -q -p no:cacheprovider plugins/stray-studio/skills/corporate-site-builder/tests plugins/stray-studio/skills/pixel-art-asset-creator/tests` after changing their scripts.
