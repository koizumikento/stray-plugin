...
- Write a frontmatter `name` and a concise, trigger-oriented `description`. Lead with the owned task; include exclusions only when they distinguish a likely neighboring task.
